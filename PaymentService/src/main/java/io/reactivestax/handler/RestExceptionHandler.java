...
//                .collect(Collectors.toList());
    ...
    public ResponseEntity<Object> vendorNotFoundException(Exception ex,
                                         WebRequest request) {
        logger.debug("start handleException ");

        RestApiResponse<RestApiStatus, ApiErrorsView> apiResponse = new RestApiResponse<>();
        RestApiStatus restApiStatus = prepareApiStatus(request, ApiStatus.VENDOR_NOT_FOUND, HttpStatus.NOT_FOUND,ex);
        apiResponse.setStatus(restApiStatus);
    ...
    public ResponseEntity<Object> resourceTypeNotFoundException(Exception ex,
                                                          WebRequest request) {
        logger.debug("start handleException ");

        RestApiResponse<RestApiStatus, ApiErrorsView> apiResponse = new RestApiResponse<>();
        RestApiStatus restApiStatus = prepareApiStatus(request, ApiStatus.RESOURCETYPE_NOT_FOUND, HttpStatus.NOT_FOUND,ex);
        apiResponse.setStatus(restApiStatus);
    ...
    public ResponseEntity<Object> expenseTypeNotFoundException(Exception ex,
                                                                WebRequest request) {
        logger.debug("start handleException ");

        RestApiResponse<RestApiStatus, ApiErrorsView> apiResponse = new RestApiResponse<>();
        RestApiStatus restApiStatus = prepareApiStatus(request, ApiStatus.EXPENSETYPE_NOT_FOUND, HttpStatus.NOT_FOUND,ex);
        apiResponse.setStatus(restApiStatus);
